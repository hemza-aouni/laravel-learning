...
Route::get('/hotel/{id}', [TenantController::class, 'dashboard']);

Route::get('/hotel/{id}/preview', [TenantController::class, 'preview']);
...
// ========== Tenant Rooms CRUD ==========
Route::post('/hotel/{id}/rooms', [TenantController::class, 'storeRoom']);
Route::put('/hotel/{id}/rooms/{roomId}', [TenantController::class, 'updateRoom']);
